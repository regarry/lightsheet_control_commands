...
function [optimalDelay] = CalcDelayV4(mmc, afg, cameraLabel, verticalP, horizontalP, rangeMs, stepSizeMs, windowSize, methodOfQuality, averageNumber, showFigure)
    ...
    mmc.setCircularBufferMemoryFootprint(1024*5);
    %Set the shutter off
    ...
    windowSize = windowSize/downSampleFactor;
