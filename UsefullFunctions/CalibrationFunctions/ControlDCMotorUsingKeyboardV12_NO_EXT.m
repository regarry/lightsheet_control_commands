...
function [markedParameters, lastWavelength, lastIntensityInMW, lastExpTime, lastPosDetStage, indWavelength, invalidTile, focusParameters, whichLightPath,galvoVoltage] = ControlDCMotorUsingKeyboardV12(...
    ...
    SetPowerOfLasersV3_NO_EXT(allLasers, wavelength,intensityInMW, focusingFilter);
    pause(3);
    ...
    focusParameters = struct('sampleXPos',0, 'sampleYPos', 0, 'sampleZPos', 0 ,...
         'posDetLens', 0, 'intensityInMW', 0, 'invalidTile', false,...
...
%                 end
            ...
            case 'd'
                ...
                outputSingleScan(myhandles.s, [0,myhandles.galvoXVoltage,myhandles.galvoYVoltage]);
            ...
            case 'u'
                ...
                SetPowerOfLasersV3_NO_EXT(myhandles.allLasers, myhandles.sFWDet,...
...
%             ' NumFocusPoints = ',num2str(myhandles.numOfFocusPoints), ' LightPath = ', num2str(myhandles.whichLightPath)]}];
        textToDisplay = [{['   Pos Det = ',posDet,'   Step Det = ',myhandles.stepSizeDetOpt{myhandles.stepSizeDetIndex},'  Exp time = ',char(expVal),'ms']};{[...
            ' intensity = ', num2str(myhandles.intensityInMW),'mW intensity step size = ',...
            num2str(myhandles.stepSizeIntensity(myhandles.stepSizeIntensityIndex)),'mW, wavelength = ',...
            num2str(myhandles.wavelengthList(myhandles.indWavelength)),' nm, InvalidTile =' num2str(myhandles.invalidTile),...
            ' NumFocusPoints = ',num2str(myhandles.numOfFocusPoints), ' LightPath = ', num2str(myhandles.whichLightPath)]};...
