...
function [scanCalibrationParameters] = FindDetStagePosExcStagePosForScanV7(depthOfScan,...
    ...
    expTime, whichQualityMeasure, lightSheetMode, manualFocus, autoParameters)
