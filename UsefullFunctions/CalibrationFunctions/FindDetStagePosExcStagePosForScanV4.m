...
function [scanCalibrationParameters] = FindDetStagePosExcStagePosForScanV4(depthOfScan,...
    ...
    expTime, lightSheetMode, manualFocus, autoParameters)
...
%     if (~manualFocus)
%         
%         %Make sure that you are in focus first
...
%         [bestExcitationLensPos, imageAtbestExcitationLensPos, actualScanLocations, qualityMeasureVector] = CenterTheLightSheetV3(...
%     relativePositionRangeExtUm, scanResExtUm, whichQualityMeasure, aveNum,...
%     controlParameters, expTime, moveToBestFocalPoint, lightSheetMode);
%          
%         %Show the images
%         if (showImages)
...
%     end
    ...
    controlParameters, expTime, moveToBestFocalPoint, lightSheetMode);
            ...
            focusingFilter = false;
            if (lightSheetMode)
              [markedParameters, lastWavelength, lastIntensityInMW, lastExpTime, lastPosDetStage, lastPosExtStage, indWavelength] = ControlDCMotorUsingKeyboardV9(...
