...
function [markedParameters, lastWavelength, lastIntensityInMW, lastExpTime, lastPosDetStage, lastPosExtStage, indWavelength] = ControlDCMotorUsingKeyboardV9(...
...
function [] = KeyReleaseFcn(src, evt)
        ...
        textToDisplay = [{['Pos Ext = ',posExt,'   Step Ext = ',myhandles.stepSizeExtOpt{myhandles.stepSizeExtIndex},...
            ...
            num2str(myhandles.stepSizeIntensity(myhandles.stepSizeIntensityIndex)),'mW, wavelength = ', num2str(myhandles.wavelengthList(myhandles.indWavelength)),' nm']}];
