...
function [ xyzScanArray, dirNames ] = CreateScanCordCurrentCenterV2(centerX, centerY, centerZ, vertTilesNum, horzTilesNum, stepSize )
    ...
    if ((mod(numel(zVec),2) == 0) && (mod(numel(yVec),2) == 0) )
        zVec = stepSize*zVec + centerZ + stepSize/4;
        yVec = stepSize*yVec + centerY + stepSize/4;
    end
