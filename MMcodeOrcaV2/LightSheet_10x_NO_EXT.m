...
addpath('D:\MatlabCodeLSMOrcaMM2\AfgCode','D:\MatlabCodeLSMOrcaMM2\DCMotor',...
    'D:\MatlabCodeLSMOrcaMM2\FilterWheel','D:\MatlabCodeLSMOrcaMM2\OBISGeneral',...
    'D:\MatlabCodeLSMOrcaMM2\UsefullFunctions\CalibrationFunctions','D:\MatlabCodeLSMOrcaMM2\MMcodeOrcaV2',...
    'D:\MatlabCodeLSMOrcaMM2\UsefullFunctions\PickTiles');
...
shutters = addAnalogOutputChannel(s,'Board0', 'Ao1', 'Voltage');
galvoX = addAnalogOutputChannel(s,'Board0', 'Ao2', 'Voltage');
galvoY= addAnalogOutputChannel(s,'Board0', 'Ao3', 'Voltage');
...
controlParameters = struct('MMC', mmc, 'cameraLabel', cameraLabel, 'stageLabel', stageLabel, ...
    'sFWDet', sFWDet,'sDetLens',...
    sDetLens,'afg', afg,'shutters',shutters, 'galvoX',galvoX,'galvoY',galvoY,'s',s);
...
laserParameters = struct('wavelength', 405, 'maxPower', 50, 'available', false, 'filterEmission', 1,...
    'filterAF', 1,'filterExcitation', 1,'posDetLens', [0; 0], 'symmetry',...
...
[markedParameters, wavelength, intensityInMW, expTime, lastPosDetStage,...
   indWavelength, invalidTile, focusParameters, curPath,galvoVoltage] = ControlDCMotorUsingKeyboardV12_NO_EXT(...
    curPath, controlParameters, allLasers, frameRate, expTime,...
    wavelength, intensityInMW, focusingFilter, false, addLine);
...
%     end
    for ii = startIndex:endIndex
        ...
        SetPowerOfLasersV3_NO_EXT(allLasers, controlParameters.sFWDet, markedParameters(ii).wavelength,markedParameters(ii).intensity(curPath), focusingFilter);
        MoveStagesToDesiredLocation_NO_EXT(controlParameters, markedParameters(ii).posDetStage(curPath));
        pause(4);
        ...
        ControlDCMotorUsingKeyboardV12_NO_EXT(...
    curPath, controlParameters, allLasers, frameRate, expTime,...
...
if (count == 1)
    ...
    [markedParameters, wavelength, intensityInMW, expTime, lastPosDetStage, indWavelength, invalidTile, focusParameters, curPath] = ControlDCMotorUsingKeyboardV12_NO_EXT(...
        curPath, controlParameters, allLasers, frameRate, expTime,...
